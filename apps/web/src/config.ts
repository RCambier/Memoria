...
/**
 * Everything the app asks Google for: file access scoped to files it
 * created, plus basic profile (name, picture, email) so the account menu
 * can show who's signed in. All non-sensitive scopes.
 */
